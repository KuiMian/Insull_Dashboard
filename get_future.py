...
SOLAR_TARGET = ['datetime', 'solarradiation', 'solarenergy', 'temp', 'cloudcover']
...
def generate_csv_data(ApiQuery, filename):
    ...
    filename = f'{now_path}{filename}{suffix}.csv'
...
for sheet in sheets:
    ...
    data = pd.read_excel('wind_locations.xlsx', sheet_name=sheet)[[name, latitude, longitude]]
